defmodule IfscServiceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(IfscServiceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(IfscServiceWeb.Gettext, "errors", msg, opts)
    end
  end
